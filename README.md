...
- `EVOLUTION_API_BASE_URL` (url interna da Evolution API do SaaS)
- `EVOLUTION_API_KEY` (apikey interna do SaaS para a Evolution API)
...
- `POST /v1/whatsapp/session/sync?tenantId=UUID`
